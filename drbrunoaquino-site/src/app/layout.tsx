      ...
      <body className="bg-white">
        ...
        {pixelId && (
          <>
            ...
            />
            <script dangerouslySetInnerHTML={{ __html: `document.addEventListener('click',function(e){var a=e.target.closest&&e.target.closest('a[href*="pay.hotmart.com"]');if(a&&window.fbq)fbq('track','InitiateCheckout',{value:129.90,currency:'BRL'});},true);` }} />
          </>
        )}
        {gaId && (
          <>
